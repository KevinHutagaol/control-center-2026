...
add_tree(datas, m6_ui,      os.path.join("pages", "Modul6",  "UI6"))
add_tree(datas, m7_ui,      os.path.join("pages", "Modul7",  "UI"))
add_tree(datas, m8_ui,      os.path.join("pages", "Modul8",  "ui_8"))
add_tree(datas, m8_asset,   os.path.join("pages", "Modul8",  "asset_8"))
